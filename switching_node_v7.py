...
log=open("switching_log_v7.csv","w",newline="")
w=csv.writer(log)
w.writerow(["time","mode","fused_x","fused_y","fused_z","fused_qx","fused_qy","fused_qz","fused_qw","gt_x","gt_y","gt_z","feat_count"])
cnt=[0]
...
def main():
    rospy.init_node("switching_node_v7",anonymous=True)
    ...
    print("Switching node v7 listening...")
    rospy.spin()
