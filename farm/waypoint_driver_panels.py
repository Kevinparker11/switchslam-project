...
# Panel-parallel route: REAL waypoints extracted from actual ground truth
# of a successful manual drive alongside the panels (not a guess).
WAYPOINTS = [
    (0.7, 0.5), (5.2, 3.6), (11.9, 7.3), (17.8, 10.7), (14.3, 13.9),
    (8.4, 18.7), (2.2, 23.0), (-4.8, 26.1), (-11.6, 29.5), (-19.0, 31.4),
    (-26.5, 33.3), (-34.0, 34.5), (-41.7, 35.1), (-49.1, 36.7),
    (-56.8, 36.7), (-64.4, 36.6), (-72.1, 36.7), (-79.8, 36.7),
]
...
def main():
    rospy.init_node("waypoint_driver_panels")
    ...
    while current_pos["x"] is None and not rospy.is_shutdown():
        rate.sleep()
    print("Following panel-parallel route, %d waypoints." % len(WAYPOINTS))
