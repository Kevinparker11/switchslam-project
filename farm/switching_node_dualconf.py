...
log=open("switching_log_dualconf.csv","w",newline="")
w=csv.writer(log)
...
def main():
    rospy.init_node("switching_node_dualconf",anonymous=True)
    ...
    print("Switching node (dualconf) listening...")
    rospy.spin()

if __name__=="__main__":
    try: main()
    finally:
        log.close(); print("Saved switching_log_dualconf.csv")
