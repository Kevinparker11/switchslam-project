...
log=open("switching_log_multifloor_gt.csv","w",newline="")
w=csv.writer(log)
...
def main():
    rospy.init_node("switching_node_multifloor_gt",anonymous=True)
    ...
    print("Switching node (multifloor_gt) listening...")
    rospy.spin()

if __name__=="__main__":
    try: main()
    finally:
        log.close(); print("Saved switching_log_multifloor_gt.csv")
