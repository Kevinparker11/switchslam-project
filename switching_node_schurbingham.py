...
log=open("switching_log_schurbingham.csv","w",newline="")
w=csv.writer(log)
...
def main():
    rospy.init_node("switching_node_schurbingham",anonymous=True)
    ...
    print("Switching node (schurbingham) listening...")
    rospy.spin()

if __name__=="__main__":
    try: main()
    finally:
        log.close(); print("Saved switching_log_schurbingham.csv")
