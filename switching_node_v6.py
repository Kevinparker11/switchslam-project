...
log=open("switching_log_v6.csv","w",newline="")
w=csv.writer(log)
...
def main():
    rospy.init_node("switching_node_v6",anonymous=True)
    ...
    print("Switching node v6 listening...")
    rospy.spin()

if __name__=="__main__":
    try: main()
    finally:
        log.close(); print("Saved switching_log_v6.csv")
