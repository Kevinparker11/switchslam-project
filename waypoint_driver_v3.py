...
WAYPOINTS = [
    (0.0, 0.0), (1.0, -3.3), (1.1, -6.6), (2.8, -10.0), (3.5, -13.6),
    (2.9, -17.0), (0.1, -20.3), (1.7, -23.7), (1.5, -27.1), (2.3, -30.3),
    (0.8, -33.7), (-0.5, -37.1), (-1.9, -40.5), (-3.4, -43.8), (-5.1, -47.2),
    (-7.8, -50.6), (-11.7, -54.0), (-15.8, -57.2), (-18.6, -60.6),
    (-31.8, -64.0), (-48.8, -67.4), (-48.1, -70.7), (-46.6, -74.1),
    (-44.8, -77.5), (-43.0, -80.9),
]
...
def main():
    rospy.init_node("waypoint_driver_v3")
    ...
    while current_pos["x"] is None and not rospy.is_shutdown():
        rate.sleep()
    print("Following real extracted Farm trajectory, %d waypoints." % len(WAYPOINTS))
