#!/usr/bin/env python3
path = "/root/catkin_ws/src/VINS-Fusion-noetic-Opencv4/vins_estimator/src/estimator/estimator.cpp"
...
hessian_block = solve_anchor + """
    ...
    {
        static ros::Publisher pubVinsHessian;
        static bool pub_initialized = false;
        if (!pub_initialized) {
            ros::NodeHandle nh_hess;
            pubVinsHessian = nh_hess.advertise<std_msgs::Float64MultiArray>("/vins_hessian", 100);
            pub_initialized = true;
        }

        ceres::Problem::EvaluateOptions eval_options;
        eval_options.parameter_blocks.push_back(para_Pose[frame_count]);
...
print("VINS Hessian patch applied successfully.")
