...
log=open("switching_log_timedecay.csv","w",newline="")
w=csv.writer(log)
...
def main():
    rospy.init_node("switching_node_timedecay",anonymous=True)
    ...
    print("Switching node (timedecay) listening...")
    rospy.spin()

if __name__=="__main__":
    try: main()
    finally:
        log.close(); print("Saved switching_log_timedecay.csv")
