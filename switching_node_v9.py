...
log=open("switching_log_v9.csv","w",newline="")
w=csv.writer(log)
...
def main():
    rospy.init_node("switching_node_v9",anonymous=True)
    ...
    print("Switching node v9 listening...")
    rospy.spin()

if __name__=="__main__":
    try: main()
    finally:
        log.close(); print("Saved switching_log_v9.csv")
